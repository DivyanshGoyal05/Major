...
with open("E:\Artificial_Intelligence\Major\RoboCatch-A-Self-navigation-Water-based-Waste-Collector\Floating-Garbage-Detection\model\obj.names") as file_object:
...
net = cv2.dnn.readNet("E:\Artificial_Intelligence\Major\RoboCatch-A-Self-navigation-Water-based-Waste-Collector\Floating-Garbage-Detection\model\custom-yolov4-tiny-detector_last.weights","E:\Artificial_Intelligence\Major\RoboCatch-A-Self-navigation-Water-based-Waste-Collector\Floating-Garbage-Detection\model\custom-yolov4-tiny-detector.cfg")
